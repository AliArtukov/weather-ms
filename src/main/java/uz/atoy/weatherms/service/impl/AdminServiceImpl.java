...
public class AdminServiceImpl implements AdminService {
    ...
    public AdminServiceImpl(UserInfoMapper userInfoMapper, UserSubscriptionMapper userSubscriptionMapper, CityInfoMapper cityInfoMapper, WeatherInfoMapper weatherInfoMapper, UserInfoRepository userInfoRepository, UserSubscriptionRepository userSubscriptionRepository, CityInfoRepository cityInfoRepository, WeatherInfoRepository weatherInfoRepository) {
    ...
    @Override
    public ResponseEntity<List<UserSubscriptionDto>> getUserSubscriptionsByUserId(Integer userId) {
